...
test("XRegExp.isRegExp", function () {
    ...
    ok(!XRegExp.isRegExp(function () {
    }), "Function literal is not RegExp");
...
test("String.prototype.replace", function () {
    ...
    equal("xaaa".replace("a", function ($0) {
        return $0;
    }), "xaaa", "String search with function replacement, using match");
...
test("Type conversion", function () {
    ...
    equal(String.prototype.replace.call(100, /0/, function ($0, pos, str) {
        return typeof str;
    }), "1string0", "String.prototype.replace: typeof last argument in replacement function is string, when called on number as context");
